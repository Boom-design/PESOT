    ...
    Route::middleware('auth')->group(function () {
        ...
        Route::get('/staff/jobs/all/list',                    [StaffWebController::class, 'allJobPostings'])->name('staff.jobs.all');
    ...
    Route::middleware('auth')->group(function () {
        ...
        Route::post('/jobseeker/applications/{id}/office-response', [ApplicationController::class, 'respondOfficeParticipation'])->name('jobseeker.applications.officeResponse');
