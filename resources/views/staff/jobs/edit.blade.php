...
<div class="mb-4">
    <h5 class="fw-bold mb-1" style="color:var(--g-700);">
        <i class="ph-fill ph-pencil-simple me-2" style="color:var(--g-600);"></i>Edit Job Vacancy
    </h5>
    <p class="mb-0" style="font-size:13px;color:var(--n-500);">Update job vacancy details</p>
</div>
    ...
    <div class="card-body p-4">
        <form action="{{ route('staff.jobs.update', $job->job_qualifications_id) }}" method="POST">
            ...
            <div class="row g-3 mb-3">
                <div class="col-md-6">
                    <label class="form-label fw-semibold small" style="color:var(--g-700);">Location</label>
                    <input type="text" name="location" class="form-control"
                        style="border:1px solid var(--n-200);border-radius:10px;font-size:13px;"
                        value="{{ old('location', $job->location) }}" required>
                </div>
                <div class="col-md-6">
                    <label class="form-label fw-semibold small" style="color:var(--g-700);">Job Type</label>
            ...
            <div class="row g-3 mb-3">
                <div class="col-md-6">
                    <label class="form-label fw-semibold small" style="color:var(--g-700);">Slots</label>
                    <input type="number" name="slots" class="form-control"
                        style="border:1px solid var(--n-200);border-radius:10px;font-size:13px;"
                        value="{{ old('slots', $job->slots) }}" min="1" required>
                </div>
                <div class="col-md-6">
                    <label class="form-label fw-semibold small" style="color:var(--g-700);">Deadline</label>
            ...
            <div class="mb-4">
                <label class="form-label fw-semibold small" style="color:var(--g-700);">Status</label>
            ...
            <div class="d-flex gap-2">
                <button type="submit" class="btn fw-semibold"
                    ...
                    <i class="ph-fill ph-check-circle me-2"></i>Update Vacancy
                </button>
