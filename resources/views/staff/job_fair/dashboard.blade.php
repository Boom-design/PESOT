...
<div class="mb-4">
    <h5 class="fw-bold mb-1" style="color:#2d7a5f;">
        <i class="bi bi-calendar-event-fill me-2" style="color:#4dd9c0;"></i>Job Fair Dashboard
    </h5>
    <p class="mb-0" style="font-size:13px;color:#888;">Manage job fair events and notifications</p>
</div>
...
<div class="row g-3 mb-4">
    <div class="col-md-4">
        <div class="card border-0 shadow-sm rounded-3 p-4 text-center">
            <div class="fs-1 fw-bold" style="color:#4dd9c0;">{{ $totalSent }}</div>
