...
<div class="mb-4">
    <h5 class="fw-bold mb-1" style="color:#2d7a5f;">
        <i class="bi bi-globe me-2" style="color:#4dd9c0;"></i>SRA Dashboard
    </h5>
    <p class="mb-0" style="font-size:13px;color:#888;">Overseas Jobseeker Registrations</p>
</div>
...
<div class="row g-3 mb-4">
    <div class="col-md-4">
        <div class="card border-0 shadow-sm rounded-3 p-4 text-center">
            ...
            <div class="text-muted small">Total Overseas Registrations</div>
        </div>
    </div>
</div>
    ...
    <div class="col-6 col-md-4">
        <a href="{{ route('staff.registrations') }}" class="text-decoration-none">
            <div class="card border-0 shadow-sm rounded-3 p-4 text-center"
                ...
                <div class="fw-bold" style="color:#2d7a5f;font-size:14px;">Overseas Jobseekers</div>
                <div class="text-muted small mt-1">View all overseas registrations</div>
            </div>
        </a>
    </div>
    <div class="col-6 col-md-4">
    ...
    <div class="col-6 col-md-4">
        <a href="{{ route('staff.jobfair.events') }}" class="text-decoration-none">
            <div class="card border-0 shadow-sm rounded-3 p-4 text-center"
                ...
                <div class="fw-bold" style="color:#2d7a5f;font-size:14px;">Job Fair</div>
                <div class="text-muted small mt-1">View job fair events</div>
            </div>
        </a>
    </div>
    <div class="col-6 col-md-4">
