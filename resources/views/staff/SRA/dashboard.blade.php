...
<div class="row g-3 mb-3">
    <div class="col-md-4">
        <div class="card border-0 shadow-sm rounded-3 p-3 text-center">
            <div class="fs-2 fw-bold" style="color:var(--g-600);">{{ $total }}</div>
    ...
    <div class="col-6 col-md-4">
        <a href="{{ route('staff.registrations') }}" class="text-decoration-none">
            <div class="card border-0 shadow-sm rounded-3 p-3 text-center"
                ...
                <div class="fw-bold" style="color:var(--g-700);font-size:14px;">Overseas Jobseekers</div>
    ...
    <div class="col-6 col-md-4">
        <a href="{{ route('staff.inhouse') }}" class="text-decoration-none">
            <div class="card border-0 shadow-sm rounded-3 p-3 text-center"
                ...
                <div class="fw-bold" style="color:var(--g-700);font-size:14px;">In-house Schedules</div>
    ...
    <div class="col-6 col-md-4">
        <a href="{{ route('staff.jobfair.events') }}" class="text-decoration-none">
            <div class="card border-0 shadow-sm rounded-3 p-3 text-center"
                ...
                <div class="fw-bold" style="color:var(--g-700);font-size:14px;">Job Fair</div>
