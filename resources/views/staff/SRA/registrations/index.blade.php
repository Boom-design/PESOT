...
<div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-2">
    <h5 class="fw-bold mb-0">
        <i class="bi bi-globe me-2" style="color:#4dd9c0;"></i>List of Overseas Jobseekers
    </h5>
...
@if($registrations->isEmpty())
    <div class="card border-0 shadow-sm rounded-3 p-5 text-center">
        ...
        <p class="text-muted mt-3 mb-0">No overseas registrations found.</p>
    </div>
@else
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="font-size:13px;padding:12px 16px;">
                            ...
                            @else
                                <span style="color:#2d7a5f;font-weight:600;">Applied</span>
                            @endif
                        </td>
