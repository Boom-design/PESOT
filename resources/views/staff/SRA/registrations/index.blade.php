...
<div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-2">
    <h5 class="fw-bold mb-0">
        <i class="ph ph-globe me-2" style="color:var(--g-600);"></i>List of Overseas Jobseekers
    </h5>
...
@if($registrations->isEmpty())
    <div class="card border-0 shadow-sm rounded-3 p-5 text-center">
        ...
        <p class="text-muted mt-3 mb-0">{{ $occupation || $education || $search ? 'No jobseeker matches that filter.' : 'No overseas registrations found.' }}</p>
    </div>
@else
...
@push('scripts')
<script>
    // Search — submit on enter or after 500ms pause
    let searchTimer;
