...
<div class="d-flex justify-content-between align-items-start mb-3 flex-wrap gap-2">
    <div>
        <h5 class="fw-bold mb-0" style="color:var(--g-700);">
            <i class="ph-fill ph-user-list me-2" style="color:var(--g-600);"></i>NSRP Registration
        </h5>
        <div style="font-size:12px;color:var(--n-500);">
            {{ $registrations->total() }} local jobseeker(s) registered
        </div>
    </div>
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="7" class="text-center"
                            ...
                            {{ $occupation || $education || $search ? 'No jobseeker matches that filter.' : 'No local registrations found.' }}
                        </td>
                    </tr>
                    @endforelse
                </tbody>
